CREATE DATABASE  IF NOT EXISTS `salesdb` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `salesdb`;
...
CREATE TABLE `alquiler` (
  ...
  `codlibfis` varchar(45) DEFAULT NULL,
  ...
  KEY `fk_alq_libfis_idx` (`codlibfis`),
  KEY `fk_alq_cliente_idx` (`idcliente`),
  KEY `fk_suscripcion_idx` (`idsuscripcion`),
  CONSTRAINT `fk_alq_cliente` FOREIGN KEY (`idcliente`) REFERENCES `cliente` (`idcliente`),
  CONSTRAINT `fk_alq_libfis` FOREIGN KEY (`codlibfis`) REFERENCES `libro_fisico` (`codlibfis`),
  CONSTRAINT `fk_suscripcion` FOREIGN KEY (`idsuscripcion`) REFERENCES `suscripcion` (`idsuscripcion`)
...
INSERT INTO `alquiler` VALUES (1,'ALQ-FBCB6E2C44-2','LIB-86R4F',2,1,'2020-11-04 19:26:13',NULL,'2020-12-04 19:26:13','1',1,'AV PERU 24 ','OVALO JOSE GRANDA');
...
CREATE TABLE `autor` (
  ...
  `publicaciones` varchar(45) DEFAULT NULL,
  `fecharegistro` datetime DEFAULT NULL,
  `estado` char(1) DEFAULT NULL,
  `codautor` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idautor`),
  UNIQUE KEY `codautor_unique` (`codautor`),
  CONSTRAINT `pk_persona_autor` FOREIGN KEY (`idautor`) REFERENCES `persona` (`idpersona`)
...
INSERT INTO `autor` VALUES (1,'1','2020-10-28 21:10:08','1','a46540980');
...
CREATE TABLE `carrito_tmp` (
  ...
  `subtotalalquiler` decimal(10,2) DEFAULT NULL,
  `descuentoventa` decimal(10,2) DEFAULT NULL,
  `descuentoalquiler` decimal(10,2) DEFAULT NULL,
  `fechaactualizacion` date DEFAULT NULL,
  PRIMARY KEY (`idcarrito`),
  KEY `FK_CAR_CLIENTE_idx` (`idcliente`),
  CONSTRAINT `FK_CAR_CLIENTE` FOREIGN KEY (`idcliente`) REFERENCES `cliente` (`idcliente`)
...
INSERT INTO `carrito_tmp` VALUES (1,2,'C','2020-10-30',164.85,1,10.00,160.00,3.00,8.00,0.15,'2020-11-04');
...
INSERT INTO `categoria` VALUES (1,'terror','1'),(2,'novela','1'),(3,'cuento','1'),(4,'finanzas','1');
...
CREATE TABLE `cliente` (
  ...
  CONSTRAINT `pk_persona` FOREIGN KEY (`idcliente`) REFERENCES `persona` (`idpersona`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cliente` VALUES (2,'1','2020-10-30 20:36:26','C46540888');
/*!40000 ALTER TABLE `cliente` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `condicion_entrega`
--

DROP TABLE IF EXISTS `condicion_entrega`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `condicion_entrega` (
  `idtipo` int NOT NULL,
  `descripcion` varchar(45) DEFAULT NULL,
  `estado` char(1) DEFAULT NULL,
  PRIMARY KEY (`idtipo`)
...
--
-- Dumping data for table `condicion_entrega`
--

LOCK TABLES `condicion_entrega` WRITE;
/*!40000 ALTER TABLE `condicion_entrega` DISABLE KEYS */;
/*!40000 ALTER TABLE `condicion_entrega` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `delivery` VALUES (1,10.00,'15','127','1285'),(2,15.00,'15','127','1290');
/*!40000 ALTER TABLE `delivery` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `det_carrito_tmp`
--

DROP TABLE IF EXISTS `det_carrito_tmp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `det_carrito_tmp` (
  ...
  KEY `FK_DCAR_LIBRO_idx` (`idlibro`),
  KEY `FK_DCAR_CARRITO_idx` (`idcarrito`),
  CONSTRAINT `FK_DCAR_CARRITO` FOREIGN KEY (`idcarrito`) REFERENCES `carrito_tmp` (`idcarrito`),
  CONSTRAINT `FK_DCAR_LIBRO` FOREIGN KEY (`idlibro`) REFERENCES `libro` (`idlibro`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `det_carrito_tmp`
--

LOCK TABLES `det_carrito_tmp` WRITE;
/*!40000 ALTER TABLE `det_carrito_tmp` DISABLE KEYS */;
INSERT INTO `det_carrito_tmp` VALUES (1,1,1,'V',60.00),(1,2,2,'V',50.00),(1,3,2,'A',3.00);
/*!40000 ALTER TABLE `det_carrito_tmp` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `det_sede_libro`
--

DROP TABLE IF EXISTS `det_sede_libro`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `det_sede_libro` (
  `idsede` int NOT NULL,
  `codlibfis` varchar(45) NOT NULL,
  `estado` varchar(45) DEFAULT NULL COMMENT 'r=reservado/d=disponible',
  KEY `fk_det_sede_idx` (`idsede`),
  KEY `fk_det_libfis_idx` (`codlibfis`),
  CONSTRAINT `fk_det_libfis` FOREIGN KEY (`codlibfis`) REFERENCES `libro_fisico` (`codlibfis`),
  CONSTRAINT `fk_det_sede` FOREIGN KEY (`idsede`) REFERENCES `sede` (`idsede`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `det_sede_libro`
--

LOCK TABLES `det_sede_libro` WRITE;
/*!40000 ALTER TABLE `det_sede_libro` DISABLE KEYS */;
/*!40000 ALTER TABLE `det_sede_libro` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `det_val_libro`
--

DROP TABLE IF EXISTS `det_val_libro`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `det_val_libro` (
  `idvaloracion` int DEFAULT NULL,
  `idlibro` int DEFAULT NULL,
  `idcliente` int DEFAULT NULL,
  `comentario` varchar(45) DEFAULT NULL,
  `estado` char(1) DEFAULT NULL,
  KEY `fk_det_val_idx` (`idvaloracion`),
  KEY `fk_detv_libro_idx` (`idlibro`),
  KEY `fk_detv_cliente_idx` (`idcliente`),
  CONSTRAINT `fk_detv_cliente` FOREIGN KEY (`idcliente`) REFERENCES `cliente` (`idcliente`),
  CONSTRAINT `fk_detv_libro` FOREIGN KEY (`idlibro`) REFERENCES `libro` (`idlibro`),
  CONSTRAINT `fk_detv_val` FOREIGN KEY (`idvaloracion`) REFERENCES `valoracion` (`idvaloracion`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `det_val_libro`
--

LOCK TABLES `det_val_libro` WRITE;
/*!40000 ALTER TABLE `det_val_libro` DISABLE KEYS */;
/*!40000 ALTER TABLE `det_val_libro` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `detalle_usuario_perfil` (
  ...
  CONSTRAINT `fk_detu_usuario` FOREIGN KEY (`idusuario`) REFERENCES `usuario` (`idusuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `detalle_usuario_perfil` VALUES (3,1,'1'),(1,2,'1');
...
CREATE TABLE `empleado` (
  ...
  `estado` char(1) DEFAULT NULL,
  `codempleado` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idempleado`),
  KEY `fk_emp_sede_idx` (`idsede`),
  CONSTRAINT `fk_emp_sede` FOREIGN KEY (`idsede`) REFERENCES `sede` (`idsede`),
  CONSTRAINT `pk_persona_emp` FOREIGN KEY (`idempleado`) REFERENCES `persona` (`idpersona`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `libro` (
  ...
  `idcategoria` int NOT NULL,
  `stockventa` int DEFAULT NULL,
  `stockalquiler` int DEFAULT NULL,
  `tipo` char(1) DEFAULT NULL COMMENT 'f=fisico/v=virtual',
  `idautor` int DEFAULT NULL,
  `estado` char(1) DEFAULT NULL,
  `costoalquiler` decimal(10,2) DEFAULT NULL,
  `costoventa` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`idlibro`),
  KEY `fk_autor_libro_idx` (`idautor`),
  KEY `fk_categoria_libro_idx` (`idcategoria`),
  CONSTRAINT `fk_autor_libro` FOREIGN KEY (`idautor`) REFERENCES `autor` (`idautor`),
...
INSERT INTO `libro` VALUES (1,'la ciudad y los perros','lorem ipsum is simply dummy text of the printing and typesetting industry. lorem ipsum has been',2,38,40,'f',1,'1',20.00,60.00),(2,'padre rico padre pobre','lorem ipsum is simply dummy text of the printing and typesetting industry. lorem ipsum has been',4,36,40,'f',1,'1',10.00,50.00),(3,'el vendedor mas grande del mundo','lorem ipsum is simply dummy text of the printing and typesetting industry. lorem ipsum has been',4,40,39,'f',1,'1',3.00,15.00);
...
CREATE TABLE `libro_fisico` (
  `idlibro` int NOT NULL AUTO_INCREMENT,
  `codlibfis` varchar(45) NOT NULL,
  `tipo` char(1) DEFAULT NULL COMMENT 'v=venta / a=alquiler',
  `estado` char(1) DEFAULT NULL,
  `fechaingreso` datetime DEFAULT NULL,
  PRIMARY KEY (`codlibfis`),
  KEY `fk_fisico_libro_idx` (`idlibro`),
  CONSTRAINT `fk_fisico_libro` FOREIGN KEY (`idlibro`) REFERENCES `libro` (`idlibro`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `libro_fisico` VALUES (1,'LIB-093S55','A','1','2020-11-04 17:24:20'),(1,'LIB-093SGGD','A','1','2020-11-04 17:24:26'),(1,'LIB-12322','V','0','2020-11-04 01:23:57'),(2,'LIB-43R4F','V','0','2020-11-04 01:24:41'),(3,'LIB-86R4F','A','0','2020-11-04 01:25:00'),(1,'LIB-COAMDN','V','0','2020-11-04 17:23:15'),(1,'LIB-HYDUS','V','1','2020-11-04 17:22:59'),(1,'LIB-MAZDA','V','1','2020-11-04 17:23:08'),(1,'LIB-T23455','A','1','2020-11-04 17:24:07'),(1,'LIB-T23SRG','A','1','2020-11-04 17:24:00'),(1,'LIB-TAASRG','V','1','2020-11-04 17:23:43'),(1,'LIB-TAASS','V','1','2020-11-04 17:23:35'),(1,'LIB-TRICI','V','1','2020-11-04 17:23:24'),(2,'LIB-TSSSD','A','1','2020-11-04 17:25:02'),(2,'LIB-TSSSD1','A','1','2020-11-04 17:25:08'),(2,'LIB-TSSSD2','A','1','2020-11-04 17:25:15'),(2,'LIB-TXSA23D','V','0','2020-11-04 17:24:43'),(2,'LIB-TXSA23FSD','V','0','2020-11-04 17:24:51'),(2,'LIB-TXSAD','V','0','2020-11-04 17:24:35'),(3,'LIB-TXSFAA1','A','1','2020-11-04 17:26:04'),(3,'LIB-TXSFAA2','A','1','2020-11-04 17:26:09'),(3,'LIB-TXSFAA3','A','1','2020-11-04 17:26:16'),(3,'LIB-TXSFAA4','A','1','2020-11-04 17:26:22'),(3,'LIB-TXSFGH2','V','1','2020-11-04 17:25:34'),(3,'LIB-TXSFGH3','V','1','2020-11-04 17:25:39'),(3,'LIB-TXSFGH5','V','1','2020-11-04 17:25:45'),(3,'LIB-TXSFGH6','V','1','2020-11-04 17:25:52');
...
INSERT INTO `perfil` VALUES (1,'ROLE_ADMIN','1'),(2,'ROLE_USER','1');
...
CREATE TABLE `persona` (
  ...
  `provincia` varchar(45) DEFAULT NULL,
  `distrito` varchar(45) DEFAULT NULL,
  `ubigueo` varchar(45) DEFAULT NULL,
...
INSERT INTO `persona` VALUES (1,'manuel alejandro','rios','alvarez','u201423282@upc.edu.pe','46540980','1','1','15','127','1285','15-127-1285'),(2,'Jose Manuel','Perez','alvarez','elpepe@upc.edu.pe','46540888','1','1','15','127','1285','15-127-1285');
...
CREATE TABLE `planes` (
  ...
  `descripcion` varchar(45) DEFAULT NULL,
  `tipo` varchar(45) DEFAULT NULL COMMENT '0=prueba/1=bronce/2=plata/3=primiun',
  `costo` decimal(10,2) DEFAULT NULL,
  `estado` char(1) DEFAULT NULL,
  `promoalquiler` int DEFAULT NULL COMMENT 'porcentaje de descuento alquiler',
  `promoventa` int DEFAULT NULL COMMENT 'porcentaje de descuento venta',
  `deliverygratis` char(1) DEFAULT NULL,
  PRIMARY KEY (`idplan`)
...
INSERT INTO `planes` VALUES (1,'PRUEBA','0',0.00,'1',0,0,'0'),(2,'BRONCE','1',9.00,'1',5,5,'0'),(3,'PLATA','2',15.00,'1',8,8,'0'),(4,'PREMIUN','3',20.00,'1',12,12,'1');
/*!40000 ALTER TABLE `planes` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `recepcion_alquiler`
--

DROP TABLE IF EXISTS `recepcion_alquiler`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `recepcion_alquiler` (
  `idalquiler` int NOT NULL,
  `idempleado` int DEFAULT NULL,
  `idcliente` int DEFAULT NULL,
  `idcondicionrecep` int DEFAULT NULL,
  `fecharecepcion` datetime DEFAULT NULL,
  `observacion` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idalquiler`),
  KEY `fk_dev_cli_idx` (`idcliente`),
  KEY `fk_dev_emp_idx` (`idempleado`),
  KEY `fk_dev_con_idx` (`idcondicionrecep`),
  CONSTRAINT `fk_dev_alq` FOREIGN KEY (`idalquiler`) REFERENCES `alquiler` (`idalquiler`),
  CONSTRAINT `fk_dev_cli` FOREIGN KEY (`idcliente`) REFERENCES `cliente` (`idcliente`),
  CONSTRAINT `fk_dev_con` FOREIGN KEY (`idcondicionrecep`) REFERENCES `condicion_entrega` (`idtipo`),
  CONSTRAINT `fk_dev_emp` FOREIGN KEY (`idempleado`) REFERENCES `empleado` (`idempleado`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `recepcion_alquiler`
--

LOCK TABLES `recepcion_alquiler` WRITE;
/*!40000 ALTER TABLE `recepcion_alquiler` DISABLE KEYS */;
/*!40000 ALTER TABLE `recepcion_alquiler` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `suscripcion` (
  ...
  KEY `fk_susc_cliente_idx` (`idcliente`),
  KEY `fk_susc_plan_idx` (`idplan`),
  CONSTRAINT `fk_susc_cliente` FOREIGN KEY (`idcliente`) REFERENCES `cliente` (`idcliente`),
  CONSTRAINT `fk_susc_plan` FOREIGN KEY (`idplan`) REFERENCES `planes` (`idplan`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `suscripcion` VALUES (1,2,'2020-11-03 21:09:16','1','2021-11-03 21:09:16',2);
...
INSERT INTO `usuario` VALUES (1,'mriosalvar','$2a$10$yInIfDMJodzIMr6KgvQ/i.FLxrLFtfUpTfp6ttS3M18syrUJV/g3a',1,'1'),(3,'admin','$2a$10$i2aXUaI2nBqqqi/RW0fAFelPUltF/Aif4XUNe8U7Vxn8hlyPoC9KC',2,'1');
...
CREATE TABLE `valoracion` (
  ...
  `descripcion` varchar(45) DEFAULT NULL,
  `cantestrellas` varchar(45) DEFAULT NULL,
...
CREATE TABLE `venta` (
  ...
  KEY `fk_detv_venta_idx` (`idcarrito`),
  KEY `fk_venta_libfis` (`codlibfis`),
  CONSTRAINT `fk_venta_carrito` FOREIGN KEY (`idcarrito`) REFERENCES `carrito_tmp` (`idcarrito`),
  CONSTRAINT `fk_venta_libfis` FOREIGN KEY (`codlibfis`) REFERENCES `libro_fisico` (`codlibfis`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `venta` VALUES (1,'VEN-56D8461A0C-2','LIB-COAMDN','1',NULL),(1,'VEN-56D8461A0C-2','LIB-TXSA23FSD','1',NULL),(1,'VEN-56D8461A0C-2','LIB-TXSAD','1',NULL);
...
-- Dump completed on 2020-11-06  0:02:11
